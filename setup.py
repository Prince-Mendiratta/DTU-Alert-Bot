...
def main():
    ...
    my_packages = ['Pyrogram', 'TgCrypto', 'psycopg2-binary', 'python-dotenv', 'lxml', 'bs4', 'requests', 'urllib3', 'pymongo', 'dnspython']

    env_vars = ['TG_BOT_TOKEN', 'APP_ID', 'API_HASH', 'AUTH_CHANNEL', 'MONGO_URL']
